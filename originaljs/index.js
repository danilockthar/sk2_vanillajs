	...
	if (History.enabled) {
		...
		load_page_content(path, slug.toUpperCase() ); 
	} else {
		return false;
	}
                ...
                .add({
                    ...
                    complete:function(){
                       var timer = setTimeout(function(){
                            $(".form-contacto span").css("border", "1px solid #181818");
                ...
                html = `       
                        <div class="area_nav_menu">
                            <div class="navmap">
                                ...
                                <p> / </p>
                                <span style="color:#333 !important;"> ${data.title.rendered.toUpperCase()} </span>
                            </div>
